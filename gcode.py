...
def rampPlunge(curve, toolD, rampangle, destZ, startZ):
	#How far we've ramped with the first n elements of the curve
	#dist = 0.
	
	#Number of curve segments used
	#cc = 0
	...
	#while dist < rampLen:
	#	dist += spans[cc].Length()
	#	cc += 1
	
	#FIXME: Remove
	#print "Ramped " + str(dist) + " mm in " + str(cc) + " curves"
